...
言語の構想自体は以前からあって、初めの 4〜5 週間で[コンパイラ](https://github.com/Se1getsu/shol)、5〜6 日で[ドキュメントサイト](https://se1getsu.github.io/shol/)、1〜2 日で [VSCode のシンタックスハイライト拡張機能](https://github.com/Se1getsu/shol-syntax-highlight)を制作しました。
